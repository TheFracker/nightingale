...
public class WaiterSounds8 : MonoBehaviour {
	...
	void Start () {
		...
		AudioClip ac1 = Resources.Load("Non-Iconic/Scene8/Long servant-01") as AudioClip;
		AudioClip ac2 = Resources.Load("Non-Iconic/Scene8/Long servant-02") as AudioClip;
